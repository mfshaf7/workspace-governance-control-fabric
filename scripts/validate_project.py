...
REQUIRED_PATHS = (
    ...
    "packages/control_fabric_core/src/control_fabric_core/prototype_landing_contracts.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_landing_policy.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_landing_readiness.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_maturity_contracts.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_maturity_policy.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_maturity_readiness.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_closure_authority.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_closure_policy.py",
    "packages/control_fabric_core/src/control_fabric_core/prototype_closure_readiness.py",
    ...
    "packages/control_fabric_core/src/control_fabric_core/workspace_intake_contracts.py",
    "packages/control_fabric_core/src/control_fabric_core/workspace_intake_policy.py",
    "packages/control_fabric_core/src/control_fabric_core/workspace_intake_readiness.py",
    "packages/control_fabric_core/src/control_fabric_core/workspace_inventory_contracts.py",
    "packages/control_fabric_core/src/control_fabric_core/workspace_inventory_policy.py",
    "packages/control_fabric_core/src/control_fabric_core/workspace_inventory_readiness.py",
    "packages/control_fabric_core/src/control_fabric_core/workspace_inventory_lifecycle_policy.py",
    ...
    "contracts/workspace-intake/evaluation.schema.json",
    "contracts/workspace-intake/readiness.schema.json",
    "migrations/versions/0008_workspace_intake.py",
    "contracts/workspace-active-inventory/manifest.json",
    "contracts/workspace-active-inventory/evaluation.schema.json",
    "contracts/workspace-active-inventory/lifecycle-evaluation.schema.json",
    "contracts/workspace-active-inventory/workspace-active-inventory.yaml",
    "contracts/workspace-active-inventory/workspace-inventory-promotion-request.schema.json",
    "contracts/workspace-active-inventory/workspace-inventory-promotion-readiness.schema.json",
    "contracts/workspace-active-inventory/workspace-inventory-lifecycle.yaml",
    "contracts/workspace-active-inventory/workspace-inventory-lifecycle.schema.json",
    "contracts/workspace-active-inventory/workspace-inventory-lifecycle-request.schema.json",
    "contracts/workspace-active-inventory/workspace-inventory-lifecycle-readiness.schema.json",
    "contracts/workspace-active-inventory/workspace-inventory-history.schema.json",
    "contracts/workspace-active-inventory/intake-register.schema.json",
    "contracts/workspace-active-inventory/repos.schema.json",
    "contracts/workspace-active-inventory/products.schema.json",
    "contracts/workspace-active-inventory/components.schema.json",
    "migrations/versions/0009_workspace_inventory.py",
    ...
    "contracts/prototype-maturity/README.md",
    "contracts/prototype-maturity/evaluation.schema.json",
    "contracts/prototype-maturity/source-authority-manifest.json",
    "contracts/prototype-maturity/prototype-maturity.yaml",
    "contracts/prototype-maturity/prototype-maturity.schema.json",
    "contracts/prototype-maturity/prototype-maturity-request.schema.json",
    "contracts/prototype-maturity/prototype-maturity-packet.schema.json",
    "contracts/prototype-maturity/prototype-maturity-readiness.schema.json",
    "contracts/prototype-maturity/prototype-maturity-decision.schema.json",
    "contracts/prototype-maturity/prototype-maturity-readback.schema.json",
    "contracts/prototype-maturity/prototype-maturity-receipt.schema.json",
    "contracts/prototype-maturity/prototype-registry.schema.json",
    "contracts/prototype-maturity/prototype-candidate-record.schema.json",
    "migrations/versions/0012_prototype_maturity.py",
    "contracts/prototype-closure/manifest.json",
    "contracts/prototype-closure/evaluation.schema.json",
    "contracts/prototype-closure/readiness.schema.json",
    "migrations/versions/0013_prototype_closure.py",
    ...
    "dev-integration/profiles/governance-control-fabric/scripts/backup.sh",
    ...
    "dev-integration/profiles/governance-control-fabric/scripts/restore.sh",
    ...
    "dev-integration/profiles/governance-control-fabric/scripts/lib/storage.sh",
    ...
    "contracts/prototype-ingress/README.md",
    ...
    "contracts/prototype-landing/evaluation.schema.json",
    "contracts/prototype-landing/prototype-landing.yaml",
    "contracts/prototype-landing/prototype-landing.schema.json",
    "contracts/prototype-landing/prototype-landing-entry-packet.schema.json",
    "contracts/prototype-landing/prototype-landing-request.schema.json",
    "contracts/prototype-landing/prototype-landing-plan.schema.json",
    "contracts/prototype-landing/prototype-landing-readiness.schema.json",
    "contracts/prototype-landing/prototype-registry.schema.json",
    ...
    "contracts/repository-custody/README.md",
    "contracts/repository-custody/repository-custody.yaml",
    "contracts/repository-custody/repository-custody.schema.json",
    "contracts/repository-custody/repository-custody-request.schema.json",
...
def validate_imports(repo_root: Path) -> list[str]:
    ...
    for required_route in (
        ...
        "/v1/readiness/prototype-maturity/{readiness_token}",
        "/v1/readiness/prototype-closure",
        "/v1/readiness/prototype-closure/{readiness_token}",
        "/v1/readiness/repositories",
        "/v1/readiness/repositories/{receipt_token}",
        "/v1/readiness/repository-custody",
        "/v1/readiness/repository-custody/{decision_token}",
