...
readonly STORAGE_CREDENTIAL_RETIREMENT_SECRET="${STORAGE_STATEFULSET}-pending-credential-retirement"
...
readonly STORAGE_NETWORK_ENFORCEMENT_FILE="${STATE_ROOT}/storage-network-enforcement.txt"
